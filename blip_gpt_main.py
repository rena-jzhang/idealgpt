...
import random
from transformers import get_cosine_schedule_with_warmup, AutoTokenizer, LlamaForCausalLM, AutoModelForCausalLM
from transformers import BitsAndBytesConfig

SCRATCH = Path("/projects/tir6/general/sakter/")
CACHE = SCRATCH / "cache/vicuna_pretrained_weights/vicuna-13b-v1.1" 


def IdealGPT(vqa_model, dataset, data_ids, model, processor=None, save_path='', max_n_rounds=5, print_mode='no', prompt_setting='v1a', temp_gpt=0.0):
    """
...
def parse():
    ...
    parser.add_argument('--data_root', type=str, default='/projects/tir4/data/VCR/', 
...
#     question_model.gradient_checkpointing_enable()
    ...
    IdealGPT(vqa_model,
                ...
                processor=question_model_processor,
                print_mode='no',
